...
function WelcomeSection({ location, guestName, isInvitation, isAnonymGuest, codeLink, onClickDetail }) {
  ...
  const renderGuestSection = () => {
    if (isAnonymGuest) return <h2 className="to-dearest-name">Dear Friends and Family,</h2>;
        ...
        <div className="container">
          <div className="row" css={styWrapper}>
            <div className="col-md-8 col-md-offset-2 text-center">
              <img src={WeddingImg} alt="wedding-renuka-sudheesh" />
              <h4 className="sub-title">The Wedding Reception of</h4>
              <h1 className="title">Sudheesh</h1>
              <h3 className="and"> &</h3>
              <h1 className="title"> Renuka</h1>
